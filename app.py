...
# retrieve pickles
model = pickle.load(open('pickled/svm_model.pkl', 'rb'))
tfidf = pickle.load(open('pickled/tfidf.pkl', 'rb'))
selected_features = pickle.load(open('pickled/selected_features.pkl', 'rb'))
